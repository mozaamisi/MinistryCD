                    ...
                    <div class="pad2">
                        ...
                        <form id="ContactForm" action="#">
                            <div>
                                ...
                                <a href="#" class="button">Send</a> </div>
                        </form>
                    </div>
                </article>
                {{--<article class="col2">--}}
...
<div class="body4">
    <div class="main">
        <!-- footer -->
        <footer> <span class="call">Call Center: <span>0611949968</span></span> Copyright &copy;  <a href="#">Domain Name</a> All Rights Reserved<br>
            Design by <a target="_blank" >Christelle</a>
            <!-- {%FOOTER_LINK} -->
        </footer>
        <!-- footer -->
    </div>
