...
<div class="body1">
    <div class="main">
        ...
        <header>
            ...
            <div class="wrapper">
                <ul id="icons">
                    <li><a href="https://en-gb.facebook.com/login/" class="normaltip"><img src="images/icon1.jpg" alt=""></a></li>
...
<div class="body2">
    <div class="main">
        <section id="content">
            <div class="wrapper">
                <article class="col1">
                    <div id="slider"> <img src="images/CaptureChurc.PNG" alt="" title="<strong>Villa Neverland, 2006</strong><span>9 rooms, 3 baths, 6 beds, building size: 5000 sq. ft. &nbsp; &nbsp; &nbsp; Price: $ 600 000 &nbsp; &nbsp; &nbsp;
                    ...
                    <div class="pad_left1">
                        ...
                        <div class="wrapper">
                            ...
                            <article class="cols pad_left1">
                                ...
                                <p class="pad_bot2"> <a href="index" class="color2">Main</a>,
                                    <a href="buying" class="color2">Buying</a>,
                                    <a href="about" class="color2">About</a>,
                                    <a href="renting" class="color2">Renting</a>,
                                    <a href="finance" class="color2">Finance</a>,
                                    <a href="contacts" class="color2">Contacts</a>
                                    (note that contact us form – doesn’t work).</p>
                                <a href="#" class="button">Read more</a> </article>
                        </div>
                    </div>
                </article>
